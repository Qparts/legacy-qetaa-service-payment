...
public class Shipment implements Serializable{
	...
	@Column(name="id")
	@Id
	@SequenceGenerator(name = "pay_shipment_id_seq_gen", sequenceName = "pay_shipment_id_seq", initialValue=1, allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "pay_shipment_id_seq_gen")
	private long id;
