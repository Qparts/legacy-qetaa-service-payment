...
public class Bank implements Serializable{
	...
	@Column(name="id")
	@Id
	@SequenceGenerator(name = "pay_bank_id_seq_gen", sequenceName = "pay_bank_id_seq", initialValue=1, allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "pay_bank_id_seq_gen")
	private int bankId;
	@Column(name="name")
	private String name;
	@Column(name="name_ar")
